...
class Funmovieslix : MainAPI() {
    ...
    private fun Element.toSearchResult(): SearchResponse {
        ...
        val searchQuality =
                if (this.select("div.gmr-quality-item a").text().contains("HD")) SearchQuality.HD
                else SearchQuality.HDR
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val recommendation =
                document.select("div.row.grid-container article").mapNotNull { it.toSearchResult() }
